...
def create_custom_model(reg,drop):
                ...
                for lr in learning_rates:
                    ...
                    for reg in reg_strengths:
                        for drop in drops:
                            ...
                            model = create_custom_model(reg,drop)
                            ...
                            if model_loss < running_best_loss:
                                ...
                                best_params.to_csv(path_or_buf = "all_model_parameters3.csv",mode='a',header=False)
                                print(best_model)
...
best_params.to_csv(path_or_buf = "the_best_model_parameters2.csv")
