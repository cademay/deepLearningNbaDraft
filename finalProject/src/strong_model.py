...
ax.set(xlabel="Real WS" , ylabel="Predicted WS")
ax.set(title="Predicted NBA WS vs. Real NBA WS")
...
pred_WS_2019 = y_scaler.inverse_transform(model.predict(X_2019))
WS_2019_names = X_2019_reference.playerName

pred_2019_DF = pd.DataFrame()

pred_2019_DF["names"] = WS_2019_names
pred_2019_DF["pred WS"] = pred_WS_2019

pred_2019_DF = pred_2019_DF.sort_values(by="pred WS", ascending=False)
