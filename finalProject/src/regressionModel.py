...
good_inds.remove(63)
"""
good_names = [test_names[i] for i in good_inds][8:]
good_pred = [y_pred[i] for i in good_inds][8:]
good_real = [y_real[i] for i in good_inds][8:]
...
ax = sns.barplot(x="value", y="player", hue="Win Shares", data=graphData)
print(good_names)
